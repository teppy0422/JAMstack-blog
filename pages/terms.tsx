      ...
      <Content>
        <Box mx={[0, 0, 8, 20]} my={[1, 1, 2, 4]}>
          ...
          <ul className={styles.privacy} style={{ lineHeight: "1.5rem" }}>
            <Text className={styles.subTitle}>利用規約</Text>
            <Text>
              この利用規約（以下、「本規約」といいます。）は、teppyLink（以下、「当社」といいます。）
              がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。
              登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
            </Text>
            <Text className={styles.subTitle}>第1条（適用）</Text>
            <OrderedList>
              <ListItem>
            ...
            <Text className={styles.subTitle}>第2条（利用登録） </Text>
            <OrderedList>
              <ListItem>
            ...
            <Text className={styles.subTitle}>第4条（禁止事項）</Text>
            <Text>
            ...
            <Text className={styles.subTitle}>第7条（退会）</Text>
            <Text>
            ...
            <Text className={styles.subTitle}>第10条（利用規約の変更）</Text>
            ...
            <Text className={styles.subTitle}>第11条（個人情報の取扱い）</Text>
            <Text>
              当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
            </Text>
            <Text className={styles.subTitle}>第12条（通知または連絡）</Text>
            <Text>
            ...
            <Text className={styles.subTitle}>第14条（準拠法・裁判管轄）</Text>
