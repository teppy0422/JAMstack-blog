...
const ScrollableContent: React.FC = () => {
  ...
  return (
    <Box maxWidth="100vw" overflowX="hidden" className="body_">
      ...
      <Box as="ul" className="box">
        <Box as="li" className="scroll_left" maxW={600}>
          <iframe
            src="/files/download/html/Sjp/70/8211158A40/0013.html"
            allowFullScreen
          ></iframe>
          <Text as="h4">
            {getMessage({
        ...
        <Box as="li" className="scroll_right" maxW={600}>
          <iframe
            src="/files/download/html/Sjp/70/8211158A40/0888.html"
            height="400"
            allowFullScreen
          ></iframe>
          <Text as="h4">
        ...
        <Box as="li" className="scroll_left" maxW={600}>
          <Image src="/files/download/html/Sjp/70/pointList.png" border="0" />
          <Text as="h4">
            {getMessage({
              ja: "ポイントナンバーの入力画面",
        ...
        <Box as="li" className="scroll_right">
          <Image src="/files/download/html/Sjp/70/menu70.png" maxW={600} />
          <Text as="h4">
            {getMessage({
        ...
        <Box as="li" className="scroll_left">
          <Image src="/files/download/html/Sjp/70/code.png" maxW={600} />
          <Text as="h4">
            {getMessage({
              ja: "生産準備+から上記コードを作成",
