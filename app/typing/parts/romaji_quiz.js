const Q = [
  ...
  ["ジャコウ猫", "じゃこうねこ", 150],
  ["お世話になります", "おせわになります", 100],
  ["いつもお世話になっております", "いつもおせわになっております", 150],
  ["よろしくお願いします", "よろしくおねがいします", 100],
  ["おはようございます", "おはようございます", 100],
  ["こんにちは", "こんにちは", 100],
  ["こんばんは", "こんばんは", 100],
  ["おやすみなさい", "おやすみなさい", 100],
  [
  ...
  [
    "ネタ札をクリックしたらネタが表示されます",
    "ねたふだをくりっくしたらねたがひょうじされます",
    350,
  ],
  [
    "アカウントはどのメールアドレスでも自由に作れます",
    "あかうんとはどのめーるあどれすでもじゆうにつくれます",
    350,
  ],
  [
    "タイピング速度が速い程、降雪と積雪が多くなります",
    "たいぴんぐそくどがはやいほど、こうせつとせきせつがおおくなります",
    450,
  ],
  [
    "製品の切替期間を短縮したい",
    "せいひんのきりかえじかんをたんしゅくしたい",
    300,
  ],
  [
    "もやしを買ってきたらレンチンします",
  ...
  ["生産準備が完了しました", "せいさんじゅんびがかんりょうしました", 200],
  ["データを添付してください", "でーたをてんぷしてください", 200],
  ["宜しくお願いいたします", "よろしくおねがいいたします", 150],
  ...
  ["有名な観光地はゆめタウンです", "ゆうめいなかんこうちはゆめたうんです", 350],
  ["歩道が無いので車道を歩きます", "ほどうがないのでしゃどうをあるきます", 350],
  ["この町はお弁当屋さんが無い", "このまちはおべんとうやさんがない", 300],
  [
    "街灯が無いので夜の運転が怖い",
    "がいとうがないのでよるのうんてんがこわい",
    300,
  ],
  ["謎の会議が多すぎる", "なぞのかいぎがおおすぎる", 250],
  ...
  ["スリジャヤワルダナプラコッテ", "すりじゃやわるだなぷらこって", 400],
  ...
  ["赤巻紙青巻紙黄巻紙", "あかまきがみあおまきがみきまきがみ", 450],
