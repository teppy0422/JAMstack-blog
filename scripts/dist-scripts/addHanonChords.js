...
function createHarmonyXml(root, kind = 'major', kindText = 'major') {
    let rootStep = root;
    let rootAlter = '';
    if (root === 'F#') {
        rootStep = 'F';
...
function addHanonChords(xmlContent) {
    // 既にコードがある場合はスキップ
...
exports.addHanonChords = addHanonChords;
// メイン処理
